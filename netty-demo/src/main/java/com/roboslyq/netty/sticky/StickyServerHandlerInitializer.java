...
import com.roboslyq.netty.echo.socket.EchoSocketServerHandler;
 ...
 * @since 1.0.0
 */
public class StickyServerHandlerInitializer extends ChannelInitializer<SocketChannel> {
...
//                .addLast(new StringDecoder())
                .addLast(new StickyServerChannelHandler());
    }
}